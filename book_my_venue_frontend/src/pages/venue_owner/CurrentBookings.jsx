    ...
    <div className="bookings-page">
      ...
      <div className="vbooking-summary">
        <div className="summary-card">
          ...
          <div>
            <div className="summary-value">{currentBookings.length}</div>
        ...
        <div className="summary-card">
          ...
          <div>
            <div className="summary-value">
              ₹{currentBookings.reduce((s, b) => s + b.cost, 0).toLocaleString()}
            </div>
          ...
          <div className="booking-detail-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="booking-detail-grid">
              ...
              <div className="detail-item">
                ...
                <span className={`badge ${statusColor(selectedBooking.status)}`}>
